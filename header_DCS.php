                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="programtab">
                                        <a class="dropdown-item drop-tab" href="archive">Search SP</a>
                                        <a class="dropdown-item drop-tab" href="#">Upload SP</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="accountstab">
                                        <a class="dropdown-item drop-tab" href="account_settings">Account Settings</a>
                                        <a class="dropdown-item drop-tab" href="accounts_admin">Manage Accounts</a>
                                        <a class="dropdown-item drop-tab" href="control_panel">Privileges Control Panel</a>
                                        <a class="dropdown-item drop-tab" href="mailbox">Notification</a>
                                        <a class="dropdown-item drop-tab" href="login_page">Log out</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
