...
class Users extends CI_Controller
{
  public function index()
  {
    ...
    $this->load->view("admin-module/users_view",$data);// after you stored the query results inside the $data array, you will have to send the array to the view which will display it inside the browser.
  }
}